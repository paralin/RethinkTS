...
func (MetricSeries_MetricDataType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorMetric, []int{2, 0}
}
...
func (MetricSeries_MetricDeduplicationStrategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorMetric, []int{2, 1}
}
...
func (MetricSeries_MetricTagMeta_MetricTagIndexType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorMetric, []int{2, 1, 0}
}
...
func (*GeoLocation) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{0} }
...
func (*MetricIdentifier) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{1} }
...
func (*MetricSeries) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{2} }
...
func (*MetricDatapoint) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{3} }
...
func (*MetricDatapointWithMeta) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{4} }
...
func (*MetricDatapointQuery) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{5} }
...
func (*MetricDatapointQuery_MetricDatapointTimeConstraint) Descriptor() ([]byte, []int) {
	return fileDescriptorMetric, []int{5, 0}
}
...
func (*MetricDatapointQuery_MetricDatapointTagConstraint) Descriptor() ([]byte, []int) {
	return fileDescriptorMetric, []int{5, 1}
}
...
func (*MetricDatapointQuery_MetricDatapointTagConstraint_MetricDatapointTagConstraintTag) Descriptor() ([]byte, []int) {
	return fileDescriptorMetric, []int{5, 1, 1}
}
...
func (m *GeoLocation) MarshalTo(data []byte) (int, error) {
	...
	if m.Latitude != 0 {
		data[i] = 0x9
		i++
		i = encodeFixed64Metric(data, i, uint64(math.Float64bits(float64(m.Latitude))))
	}
	if m.Longitude != 0 {
		data[i] = 0x11
		i++
		i = encodeFixed64Metric(data, i, uint64(math.Float64bits(float64(m.Longitude))))
	}
	return i, nil
}
...
var fileDescriptorMetric = []byte{
	...
	,
}
